...
- [ ] 5.1 Проверка перехода All Items;
- [ ] 5.1 Проверка перехода About;
- [ ] 5.1 Проверка Logout;
- [ ] 5.1 Проверка Reset App State.
- [ ] 5.1 Проверка закрытия "burger menu" после нажатия - X

## 6. Checkout

- [ ] 6.1 Проверка валидации полей на странице - Checkout: Your Information;
...
- [ ] 6.3 Проверка подсчетов Price Total на странице Checkout: Overview:

    - Проверка подсчета Item total;
    - Проверка подсчета Total.

- [ ] 6.4 Проверка завершения покупки на странице Checkout: Complete!.